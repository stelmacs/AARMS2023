...
parms  = c(b=50, mu_e=0.0025, mu_ql=0.006, mu_fl=0.038, mu_qn=0.006, mu_fn=0.028, mu_qa=0.006, mu_fa=0.018, mu_h1=0.012, mu_h2=0.012, d_e=0.01, d_a=0.0000542, d_n=0.0000015486, d_l=0.0000015486, f_l=0.09, f_n=0.3, f_a=0.2, beta_h1l=0.6, beta_h2l=0.6, beta_h1n=0.8, beta_h2n=0.8, beta_nh1=1, beta_nh2=1, h_1=200, h_2=500, p_1=1, p_2=1)
...
parms  = c(b=50, mu_e=0.0025, mu_ql=0.006, mu_fl=0.038, mu_qn=0.006, mu_fn=0.028, mu_qa=0.006, mu_fa=0.018, d_e=0.01, d_n=0.0000015486, d_l=0.0000015486, f_l=0.09, f_n=0.3, f_a=0.2)
...
```{r}
plot(x = out$time, y = out$E, col = "black", ylab = "Number of individuals", 
      xlab = "Time (days)", type = "l", xlim = c(0, 10000), ylim = c(0,1000))
 lines(x = out$time, y = out$L_Q, col = "yellow")
