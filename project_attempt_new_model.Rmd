...
mod5=function(t, y, parms){
  ...
  dNs = b_l*L*(1-r)*(1-a)*(1-(1-(1-delta)*(exp(Ni/((1-r)*(Hs+Hi+Hr))))))*((Hs + (1-p_hl)*Hi + Hr)/(Hs+Hi+Hr)) - b_n*Ns*(1-r) - mu_n*Ns
    
  dNi = b_l*L*(1-r)*(1-a)*p_hl*(Hi/(Hs+Hi+Hr)) + b_l*L*(1-r)*(1-a)*(1-(1-delta)*(exp(Ni/((1-r)*(Hs+Hi+Hr)))))*((Hs + (1-p_hl)*Hi + Hr)/(Hs+Hi+Hr)) - b_n*Ni*(1-r) - mu_n*Ni
...
start = c(L=10000, Ns=100, Ni=4000, A=5000, Hs=1000, Hi=2000, Hr=10)
```
